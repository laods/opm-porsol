...
/*
  ...
  opm-porsol/dune/porsol/mimetic/IncompFlowSolverHybrid.cpp,
  authors: Bård Skaflestad     <bard.skaflestad@sintef.no>
           Atgeirr F Rasmussen <atgeirr@sintef.no>

  Then modified by Lars Vingli Odsæter (lars.odsater@gmail.com)
  to fit the mortar approach.
*/
...
namespace Dune {
  ...
  class IncompFlowSolverHybridMortar {
    /// @brief
    ...
    public:
      ...
      friend class IncompFlowSolverHybridMortar;
  ...
  public:
    ...
    ///    IncompFlowSolverHybridMortar @endcode to two-phase flow
    ///    problems.
    ///
    /// @param [in] bc
    ///    The boundary conditions describing how the current flow
  ...
  public:
    ...
    {
      os << "IncompFlowSolverHybridMortar<>:\n"
